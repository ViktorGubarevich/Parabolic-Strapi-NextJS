...
const Footer = () => {
  return (
        ...
        <div className="flex justify-between pt-5 pb-6">
          ...
          <div className="hidden w-full md:flex md:items-center md:w-auto">
            <ul className="pt-4 text-base text-white md:flex md:justify-between md:pt-0 space-x-2">
              <li>
                <Link href="https://www.facebook.com/TradeSmithTM">
                  <a className="pr-4 block" target="_blank">
                    {/*eslint-disable-next-line @next/next/no-img-element */}
                    <svg
                      id="network"
	...
	C408.786,24.662,384.124,0,353.701,0z"
              ...
              <li>
                <Link href="https://twitter.com/TradeSmith_TM">
                  <a className="pr-4 block" target="_blank">
                    {/*eslint-disable-next-line @next/next/no-img-element */}
                    <svg
                      id="network"
	...
	C507.7,94.204,503.76,93.294,500.398,94.784z"
              ...
              <li>
                <Link href="https://www.linkedin.com/company/tradesmith">
                  <a target="_blank">
                    {/*eslint-disable-next-line @next/next/no-img-element */}
                    <svg
                      id="network"
	...
	L341.91,330.654L341.91,330.654z"
        ...
        <div className="flex justify-between">
          <div className="pb-4">
            ...
            <p className="text-white text-lg leading-none">
              Toll free:{" "}
              <Link href="tel:(866) 385-2076">
                <a className="text-[#007bff] hover:text-[#0056b3] hover:underline">
                  (866) 385-2076
                </a>
              </Link>{" "}
              | Local:{" "}
              <Link href="tel:(352)-593-2267">
                <a className="text-[#007bff] hover:text-[#0056b3] hover:underline">
                  (352)-593-2267
                </a>
              </Link>
            ...
            <p className="leading-none">
              <Link href="mailto:support@tradesmith.com">
                <a className="text-[#007bff] hover:text-[#0056b3] hover:underline">
        ...
        <div className="flex justify-center">
          <ul>
            <li>
              <Link href="https://tradesmith.com/tradesmith-privacy-policy/">
                <a
              ...
              <Link href="https://tradesmith.com/terms-of-service/">
                <a
                  className="text-[#007bff] hover:text-[#0056b3] hover:underline"
                  target="_blank"
                >
              ...
              <Link href="https://tradesmith.com/tradesmith-privacy-policy/#adchoice">
                <a
                  className="text-[#007bff] hover:text-[#0056b3] hover:underline"
                  target="_blank"
                >
              ...
              <Link href="https://beaconstreet-privacy.my.onetrust.com/webform/c246f198-7123-4766-b29c-917342eff0f7/27b6313f-c0de-427c-b720-3623acacb14f">
                <a
                  className="text-[#007bff] hover:text-[#0056b3] hover:underline"
                  target="_blank"
                >
